          ...
          children: [
            ...
            Flexible(
              child: Text(
                ...
                style: TextStyle(
                  decoration: (this.completed ?? this.todo?.completed ?? false)
                      ? TextDecoration.lineThrough
                      : null,
                  fontStyle: (this.completed ?? this.todo?.completed ?? false)
                      ? FontStyle.italic
                      : null,
                  fontWeight: (this.completed ?? this.todo?.completed ?? false)
                      ? FontWeight.bold
                      : null,
                ),
              ),
